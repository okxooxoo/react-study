...
const BigExhibitionCard = ({ id, image, title, price, place, period }) => {
    ...
    return (
        <div>
            <img className='big-image' src={`../${image}`} alt='전시회' />
            <div className='big-card-details'>
                <div className='big-title'>{title}</div>
                <div className='big-price'>{price.toLocaleString('ko-KR')} 원</div>
                <div className='big-details-bottom'>
                    <div className='big-details-bottom-left'>
                        <div className='big-place'>{place}</div>
                        <div className='big-period'>{period}</div>
                    </div>
...
export default BigExhibitionCard;